...
| 2025-12-4 | v1.0.3 | 1.在章节2.2 请求格式定义，增加audioBookOption进行多维度搜索；<br><br>2.在章节2.2 请求格式定义，增加batchGetPlayUrl根据trackid搜索内容地址<br><br>3.在章节2.3 响应格式定义，对playAudio增加total（总数），albumId（专辑Id，有声书类型返回）<br><br>4.增加示例2.2.3：根据声音id批量查询播放链接<br><br>5.增加示例2.3.3：返回根据声音id批量查询播放链接结果 | zw  | 无   |
